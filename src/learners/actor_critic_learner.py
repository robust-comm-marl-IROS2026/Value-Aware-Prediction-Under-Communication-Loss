...
class ActorCriticLearner:
    ...
    def save_models(self, path, save_mongo=False):
        ...
        if save_mongo:
            self.logger.log_model(filepath= "{}/critic.th".format(path), name= "critic.th")
            self.logger.log_model(filepath= "{}/agent_opt.th".format(path), name= "agent_opt.th")
            self.logger.log_model(filepath= "{}/critic_opt.th".format(path), name= "critic_opt.th")
